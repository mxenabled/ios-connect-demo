...
public protocol ConnectWidgetViewController {
    var widgetWebView: WKWebView! { get }
}

class ViewController: UIViewController, WKNavigationDelegate, WKUIDelegate, ConnectWidgetViewController {
